	...
	return (
		<S.Container>
			<S.ContentBox>
				<S.Content>
					<MyUser />
					<MyReserveContent title="예약" text="예약 내역이 없습니다." onClick={() => navigate(MYRESERVE)} />
					<MyReviewContent title="리뷰" text="작성한 리뷰가 없습니다." onClick={() => navigate(MYREVIEW)} />
					<MyDogContent title="강아지" text="등록된 강아지가 없습니다." onClick={() => navigate(MYDOG)} />
					<Withdraw />
				</S.Content>
			</S.ContentBox>
		</S.Container>

...
public class ReviewController {
    ...
    @GetMapping
    public ResponseEntity getHairShopReviews(Principal principal,
                                             @Positive @RequestParam Long hairShopId,
                                             @Positive @RequestParam int page,
                                             @Positive @RequestParam int size) {
        Page<Review> pageReviews = compositeService.getHairShopReviews(hairShopId, principal.getName(), page, size);
